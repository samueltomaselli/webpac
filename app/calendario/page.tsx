        ...
        <div className=" md:px-16 md:py-10 px-10 py-5 flex flex-col ">
            ...
            <div className="flex-col flex">
                ...
                <section className="mt-12">
                    <h2 className="text-base font-semibold leading-6 text-gray-900">Próximas aulas</h2>
                    <ol className="mt-2 divide-y divide-gray-200 text-sm leading-6 text-gray-500">
                        <li className="py-4 sm:flex">
                            <time dateTime="2022-01-19" className="w-28 flex-none">
                                Sábado, Jun 8
                            </time>
                            <p className="mt-2 flex-auto font-semibold text-gray-900 sm:mt-0">Aula 01</p>
                        ...
                        <li className="py-4 sm:flex">
                            ...
                            <p className="mt-2 flex-auto font-semibold text-gray-900 sm:mt-0">Aula 02</p>
                            <p className="flex-none sm:ml-6">
                        ...
                        <li className="py-4 sm:flex">
                            ...
                            <p className="mt-2 flex-auto font-semibold text-gray-900 sm:mt-0">Aula 03</p>
                            <p className="flex-none sm:ml-6">
                                <time dateTime="2022-01-17T10:00">07:00 AM</time> - <time dateTime="2022-01-17T10:15">10:15 AM</time>
                            </p>
                        </li>
                        <li className="py-4 sm:flex">
                            ...
                            <p className="mt-2 flex-auto font-semibold text-gray-900 sm:mt-0">Aula 04</p>
                            <p className="flex-none sm:ml-6">
                                <time dateTime="2022-01-17T10:00">07:00 AM</time> - <time dateTime="2022-01-17T10:15">10:15 AM</time>
                            </p>
                        </li>
